...
if hash or DevLucifer(msg) then  
return true  
else  
return false  
end  
...
if hash or DevLucifer(msg) or DevBot(msg) then 
return true 
else 
return false 
end 
...
if hash or DevLucifer(msg) or DevBot(msg) or BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevLucifer(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevLucifer(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
if hash or DevLucifer(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "vv0aa")
for Lucifer in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = Lucifer
end
...
message = 'متفاعل مشي حالك' 
elseif tonumber(msgs) < 700 then 
message = 'متفاعل' 
elseif tonumber(msgs) < 1200 then 
message = 'متفاعل قوي' 
elseif tonumber(msgs) < 2000 then 
message = 'متفاعل مرره قوي' 
elseif tonumber(msgs) < 3500 then 
message = 'اقوى تفاعل'  
elseif tonumber(msgs) < 4000 then 
message = 'متفاعل نار وشرار' 
elseif tonumber(msgs) < 4500 then 
message = 'ابويي يالتفاعل' 
elseif tonumber(msgs) < 5500 then 
message = 'كنق التيلي' 
elseif tonumber(msgs) < 7000 then 
message = 'كنق التيلي' 
elseif tonumber(msgs) < 9500 then 
message = 'امبروطور التيلي' 
elseif tonumber(msgs) < 10000000000 then 
message = 'تاج راس التيلي'  
end 
return message 
end
...
local Lucifer_Msg = database:get(bot_id.."Lucifer:Add:Filter:Rp2"..text..msg.chat_id_)   
if Lucifer_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","📬┇"..Lucifer_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
if text == "قفل التاق" and Addictive(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Reply_Status(msg,msg.sender_user_id_,"lock","💢️┇تم قفـل التاق")  
return false
end 
if text == "قفل التاق بالتقييد" and Addictive(msg) then
database:set(bot_id.."Lucifer:Lock:hashtak"..msg.chat_id_,"ked")  
Reply_Status(msg,msg.sender_user_id_,"lockkid","💢️┇تم قفـل التاق")  
return false
end 
if text == "قفل التاق بالكتم" and Addictive(msg) then
database:set(bot_id.."Lucifer:Lock:hashtak"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","💢️┇تم قفـل التاق")  
return false
end 
if text == "قفل التاق بالطرد" and Addictive(msg) then
database:set(bot_id.."Lucifer:Lock:hashtak"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","💢️┇تم قفـل التاق")  
return false
end 
if text == "فتح التاق" and Addictive(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Reply_Status(msg,msg.sender_user_id_,"unlock","💢️┇تم فتح التاق")  
return false
end 
...
if text == ("الغاء الحظر") and tonumber(msg.reply_to_message_id_) ~= 0 and Addictive(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء الحظر @(.*)$") and Addictive(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء الحظر (%d+)$") and Addictive(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("الغاء الكتم") and tonumber(msg.reply_to_message_id_) ~= 0 and Addictive(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء الكتم @(.*)$") and Addictive(msg) then
...
if text and text:match("^الغاء الكتم (%d+)$") and Addictive(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text == ("الغاء التقييد") and tonumber(msg.reply_to_message_id_) ~= 0 and Addictive(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text and text:match("^الغاء التقييد @(.*)$") and Addictive(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text and text:match("^الغاء التقييد (%d+)$") and Addictive(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local list = database:smembers(bot_id.."Lucifer:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Lucifer:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Lucifer:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Lucifer:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔┇قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local Lucifer_Msg = database:get(bot_id.."Lucifer:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Lucifer_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."Lucifer:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Lucifer:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Lucifer:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
...
database:del(bot_id.."Lucifer:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Lucifer:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Lucifer:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Lucifer:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
database:del(bot_id.."Lucifer:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Lucifer:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Lucifer:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
send(msg.chat_id_, msg.id_,"📫┇ارسل الكلمه اللتي تريد حذفها")
...
if database:sismember(bot_id.."Lucifer:Sudo:User",result.sender_user_id_) then
dev = "المطور ،" else dev = "" end
if database:sismember(bot_id.."Lucifer:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي ،" else crr = "" end
if database:sismember(bot_id.."Lucifer:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ ،" else cr = "" end
if database:sismember(bot_id.."Lucifer:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "مدير ،" else own = "" end
if database:sismember(bot_id.."Lucifer:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن ،" else mod = "" end
if database:sismember(bot_id.."Lucifer:Special:User"..msg.chat_id_, result.sender_user_id_) then
vip = "مميز ،" else vip = ""
end
...
if text == "تاق للكل" and Addictive(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "vv0aa")
...
database:sadd(bot_id.."Lucifer:Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end
...
if text == (database:get(bot_id.."Lucifer:Name:Bot") or ".") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."Lucifer:Name:Bot") or ".")
local namebot = {
". "..Namebot.. " . ",
". "..Namebot,
'. .',
...
if text == "بوت" then
Namebot = (database:get(bot_id.."Lucifer:Name:Bot") or "Lucifer")
...
if text and text:match("^ايدي @(.*)$") and not database:get(bot_id..'Lucifer:Lock:ID:Bot'..msg.chat_id_) then
...
KlamSpeed = {"سحور","سياره","استقبال","عبدالرحمن","ايفون","السعودية","مطبخ","تركس","دجاجه","مدرسه","الوان","غرفه","ثلاجه","قهوه","سفينه","ببجي","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","فستان","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنت","ساحه","جسر"};
...
Hzora = {"فيروز","نوال الكويتيه","ليوناردو","الزرافه","توم اليس","هتان","دبي","الفهد","نتفلكس","عبادي الجوهر","مربع","عايض","تيك توك","الفاروق","سبونج بوب","توم وجيري","ابو نوره","كبسه","تركيا","مصر","2017","7","الحوت الازرق","الجمل","اللبوة"};
name = Hzora[math.random(#Hzora)]
database:set(bot_id.."Tshak:Klam:Hzor"..msg.chat_id_,name)
name = string.gsub(name,"فيروز"," - يا عصفورة بيضا لا بقى تسألي، لا يعتب حدا ولا يزعل حدا - من هو مغني هذه الأغنية ؟ ")
...
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فار","ذيب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
...
katu = {"اطلع","فهمت","غباء","اسمعك","احبك","خايس","نظيف","حار","منخفض","زعلان","سريع","قريب","طويل","سمين","ضعيف","مجامله","شجاع","رحت","حي","نشيط","شبعان","موعطشان","رخمه","ظلام","هادئ"}
name = katu[math.random(#katu)]
database:set(bot_id.."Tshak:Set:Aks:Game"..msg.chat_id_,name)
name = string.gsub(name,"اطلع","ادخل")
name = string.gsub(name,"فهمت","مافهمت")
name = string.gsub(name,"غباء","ذكاء")
name = string.gsub(name,"اسمعك","ماسمعك")
name = string.gsub(name,"احبك","مااحبك")
name = string.gsub(name,"خايس","حلو")
name = string.gsub(name,"نظيف","وصخ")
name = string.gsub(name,"حار","بارد")
name = string.gsub(name,"منخفض","مرتفع")
name = string.gsub(name,"زعلان","مستانس")
name = string.gsub(name,"سريع","بطيء")
name = string.gsub(name,"قريب","بعيد")
name = string.gsub(name,"طويل","قزم")
name = string.gsub(name,"سمين","نحيف")
name = string.gsub(name,"ضعيف","قوي")
name = string.gsub(name,"مجامله","صراحه")
...
name = string.gsub(name,"رخمه","رجال ولد رجال")
...
if database:get(bot_id.."Tshak:Lock:Games"..msg.chat_id_) then
mthal = {"حامض","غنيله","جاره","زرع","شقره","السواهي","الموجود","نخله","الشبل","القرد","سبقني","قلة","موت","فلوس","تغني","مجانا","السرج","اقرد","التهايم","عسفان",};
...
🎁┇بيع مجوهراتي + العدد » لأستبدال كل مجوهره ب 150 رسالة
📌┇ @vv0aa
]]
...
if text and text:match("^تغير الاشتراك$") and DevLucifer(msg) then
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '📮| حسنآ ارسل لي معرف القناة') 
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevLucifer(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '📮| حسنآ ارسل لي النص الذي تريده') 
return false  
end
if text == "حذف رساله الاشتراك" and DevLucifer(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "📮| تم مسح رساله الاشتراك ") 
return false  
end
if text == "تفعيل الاشتراك الاجباري" and DevLucifer(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري"  and DevLucifer(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "📮| تم تعطيل الاشتراك الاجباري ") 
return false  
end
if text == "الاشتراك الاجباري" and DevLucifer(msg) then  
...
if not DevLucifer(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
local Name_Bot = (database:get(bot_id.."Lucifer:Name:Bot") or ".")
...
------------------------------------------------------------------------
if text then
local Lucifer_Msg = database:get(bot_id.."Lucifer:Add:Filter:Rp2"..text..result.chat_id_)   
if Lucifer_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","📬┇"..Lucifer_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
